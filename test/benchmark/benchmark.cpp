...
TEST(Benchmark, IterateTwoComponentsPersistent1M) {
    entt::registry<> registry;
    registry.old_persistent_view<position, velocity>();
    ...
    auto test = [&registry](auto func) {
        timer timer;
        registry.old_persistent_view<position, velocity>().each(func);
        timer.elapsed();
    };
...
TEST(Benchmark, IterateFiveComponentsPersistent1M) {
    entt::registry<> registry;
    registry.old_persistent_view<position, velocity, comp<1>, comp<2>, comp<3>>();
    ...
    auto test = [&registry](auto func) {
        timer timer;
        registry.old_persistent_view<position, velocity, comp<1>, comp<2>, comp<3>>().each(func);
        timer.elapsed();
    };
...
TEST(Benchmark, IterateTenComponentsPersistent1M) {
    entt::registry<> registry;
    registry.old_persistent_view<position, velocity, comp<1>, comp<2>, comp<3>, comp<4>, comp<5>, comp<6>, comp<7>, comp<8>>();
    ...
    auto test = [&registry](auto func) {
        timer timer;
        registry.old_persistent_view<position, velocity, comp<1>, comp<2>, comp<3>, comp<4>, comp<5>, comp<6>, comp<7>, comp<8>>().each(func);
        timer.elapsed();
    };
